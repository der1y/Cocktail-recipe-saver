...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "User1 Name", "Cleveland", "OH");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "User2 Name", "Beverly Hills", "CA");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "User3 Name", "Chicago", "IL");
    ...
    public void create_user_with_null_username() {
        dao.createUser(
                new User(null, USER_3.getPassword(), "ROLE_USER", USER_3.getName(), USER_3.getCity(), USER_3.getStateCode())
        );
    }
    ...
    public void create_user_with_existing_username() {
        dao.createUser(
                new User(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", USER_3.getName(), USER_3.getCity(), USER_3.getStateCode())
        );
    }
    ...
    public void create_user_with_null_password() {
        dao.createUser(
                new User(USER_3.getUsername(), null, "ROLE_USER", USER_3.getName(), USER_3.getCity(), USER_3.getStateCode())
        );
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User("new", "user", "ROLE_USER", "new user", "city", "ST");
